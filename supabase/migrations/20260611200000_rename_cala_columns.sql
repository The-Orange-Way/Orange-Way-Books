...
--
-- After the Phase 1 schema squash + legacy-ledger removal, two columns kept their
...
-- names in line with the post-legacy ledger backend mental model, where these IDs point at
-- post-legacy ledger backend chart_of_accounts / journal_entries (or stay NULL pending
