...
export const TRANSACTION_COLUMNS = ['Date', 'Wallet', 'Direction', 'Amount', 'Account', 'Contact', 'Memo'];
...
const DIRECTION_MAP: Record<string, string> = {
  inflow: 'INFLOW', in: 'INFLOW', income: 'INFLOW',
  outflow: 'OUTFLOW', out: 'OUTFLOW', expense: 'OUTFLOW',
};

export function parseCsvTransactions(csvText: string): { rows: ImportPreviewRow[]; errors: string[] } {
