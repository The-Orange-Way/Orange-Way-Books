/**
 * S8: printable / save-as-PDF recovery kit backup.
 *
...
export function openRecoveryBackup({
  ...
  if (words.length !== 12) {
    throw new Error('Recovery kit must be exactly 12 words.');
  }
...
<head>
  <meta charset="utf-8" />
  <title>Orange Way Books Vault Recovery Kit</title>
  <style>
...
<body>
  ...
  <h1>Orange Way Books Vault Recovery Kit</h1>
  <div class="meta">
  ...
  <div class="footer">
    ...
    <p>If you ever generate a new recovery kit, this one stops working immediately. Shred this paper.</p>
  </div>
